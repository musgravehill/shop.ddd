...
final class CityName extends ValueObjectAbstract implements ValueObjectInterface
{
    //self-validation
    ...
    {
        return sha1(serialize([$this->cityName])); //you can add params (color white-red, size S-M-L) to array
    }
