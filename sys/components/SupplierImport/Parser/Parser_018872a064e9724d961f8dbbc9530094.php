...
//SEO 
class Parser_018872a064e9724d961f8dbbc9530094 implements ParserInterface
{
    const PRICELIST_URL = 'http://sd.teamtimer.ru/prc/bn-seo.xml';
    ...
    public function run(): Generator
    {
        ...
        while ($node = $streamer->getNode()) {
            ...
            $imgUrl = (string) $data->picture;

            if (!isset($imgUrl[8]) || !isset($vendor[1])) {
                continue;
            }
